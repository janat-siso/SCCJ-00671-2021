...
<head>
  ...
  <title>localhost / 127.0.0.1 / green apple | phpMyAdmin 5.2.0</title>
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=green+apple&table=underweight+meal+plan">
    `green apple`.`underweight meal plan`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=green+apple&table=overweight+meal+plan">
    `green apple`.`overweight meal plan`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=green+apple&table=user+details">
    `green apple`.`user details`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=contacts&table=comment_section">
    `contacts`.`comment_section`
  </a>
</li>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.Y29udGFjdHM=" data-vpath="cm9vdA==.Y29udGFjdHM=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=contacts"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=contacts" title="Structure">contacts</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.Z3JlZW4gYXBwbGU=" data-vpath="cm9vdA==.Z3JlZW4gYXBwbGU=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=green+apple"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=green+apple" title="Structure">green apple</a>
  ...
  <li class="last database">
    ...
    <div class="clearfloat"></div>
      ...
      <div id="pma_navi_settings_container">
                  <div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fstructure&amp;db&#x3D;green&#x2B;apple&amp;server&#x3D;1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="2448497b7e2a3d4c285e43457c664f3d">
  ...
  <ol class="breadcrumb breadcrumb-navbar">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="127.0.0.1" draggable="false">
        ...
        <a href="index.php?route=/database/structure&db=green+apple" data-raw-text="green apple" draggable="false">
          Database:          green apple
        </a>
      </li>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul id="topmenu" class="navbar-nav">
            ...
            <a class="nav-link text-nowrap" href="index.php?route=/database/structure&db=green+apple">
              <img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure
                              <span class="visually-hidden">(current)</span>
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/sql&db=green+apple">
              <img src="themes/dot.gif" title="SQL" alt="SQL" class="icon ic_b_sql">&nbsp;SQL
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/search&db=green+apple">
              <img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_search">&nbsp;Search
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/multi-table-query&db=green+apple">
              <img src="themes/dot.gif" title="Query" alt="Query" class="icon ic_s_db">&nbsp;Query
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/export&db=green+apple">
              <img src="themes/dot.gif" title="Export" alt="Export" class="icon ic_b_export">&nbsp;Export
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/import&db=green+apple">
              <img src="themes/dot.gif" title="Import" alt="Import" class="icon ic_b_import">&nbsp;Import
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/operations&db=green+apple">
              <img src="themes/dot.gif" title="Operations" alt="Operations" class="icon ic_b_tblops">&nbsp;Operations
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/server/privileges&db=green+apple&checkprivsdb=green+apple&viewing_mode=db">
              <img src="themes/dot.gif" title="Privileges" alt="Privileges" class="icon ic_s_rights">&nbsp;Privileges
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/routines&db=green+apple">
              <img src="themes/dot.gif" title="Routines" alt="Routines" class="icon ic_b_routines">&nbsp;Routines
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/events&db=green+apple">
              <img src="themes/dot.gif" title="Events" alt="Events" class="icon ic_b_events">&nbsp;Events
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/triggers&db=green+apple">
              <img src="themes/dot.gif" title="Triggers" alt="Triggers" class="icon ic_b_triggers">&nbsp;Triggers
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/tracking&db=green+apple">
              <img src="themes/dot.gif" title="Tracking" alt="Tracking" class="icon ic_eye">&nbsp;Tracking
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/designer&db=green+apple">
              <img src="themes/dot.gif" title="Designer" alt="Designer" class="icon ic_b_relations">&nbsp;Designer
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/central-columns&db=green+apple">
  ...
  <div id="pma_console_container" class="d-print-none">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="contacts" targettable="comment_section">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `comment_section`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="contacts" targettable="comment_section">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            targetdb="green apple" targettable="user details">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `green apple`.`user details` (`username` VARCHAR(20) NOT NULL , `email address` VARCHAR(25) NOT NULL , `password` VARCHAR(10) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="green apple" targettable="user details">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `user details` ADD PRIMARY KEY(`username`);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="green apple" targettable="overweight meal plan">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `green apple`.`overweight meal plan` (`Sunday` INT(255) NOT NULL , `Monday` VARCHAR(255) NOT NULL , `Tuesday` VARCHAR(255) NOT NULL , `Wednesday` VARCHAR(255) NOT NULL , `Thursday` VARCHAR(255) NOT NULL , `Friday` VARCHAR(255) NOT NULL , `Saturday` VARCHAR(255) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="green apple" targettable="underweight meal plan">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `green apple`.`underweight meal plan` (`Sunday` VARCHAR(1000) NOT NULL , `Monday` VARCHAR(1000) NOT NULL , `Tuesday` VARCHAR(1000) NOT NULL , `Wednesday` VARCHAR(1000) NOT NULL , `Thursday` VARCHAR(1000) NOT NULL , `Friday` VARCHAR(1000) NOT NULL , `Saturday` VARCHAR(1000) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="green apple" targettable="overweight meal plan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `overweight meal plan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="green apple" targettable="overweight meal plan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `underweight meal plan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="green apple" targettable="underweight meal plan">
                            <div class="action_content">
...
<div id="page_settings_modal"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fstructure&amp;db&#x3D;green&#x2B;apple&amp;server&#x3D;1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="2448497b7e2a3d4c285e43457c664f3d">
...
<input type="hidden" name="db" value="green apple"><input type="hidden" name="token" value="2448497b7e2a3d4c285e43457c664f3d">
<div class="table-responsive">
<table class="table table-light table-striped table-hover table-sm w-auto data">
    <thead class="table-light">
        <tr>
            <th class="d-print-none"></th>
            <th><a href="index.php?route=/database/structure&db=green+apple&pos=0&sort=table&sort_order=DESC" title="Sort" onmouseover="$(&#039;.sort_arrow&#039;).toggle();" onmouseout="$(&#039;.sort_arrow&#039;).toggle();">Table <img src="themes/dot.gif" title="" alt="Ascending" class="icon ic_s_asc sort_arrow"> <img src="themes/dot.gif" title="" alt="Descending" class="icon ic_s_desc sort_arrow hide"></a></th>
            
                                                                                            <th colspan="7" class="d-print-none">
                Action            </th>
                        <th>
                <a href="index.php?route=/database/structure&db=green+apple&pos=0&sort=records&sort_order=DESC" title="Sort">Rows</a>
                <span class="pma_hint"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_help"><span class="hide">May be approximate. Click on the number to get the exact count. See <a href="./doc/html/faq.html#faq3-11" target="documentation">FAQ 3.11</a>.</span></span>
                            ...
                            <th><a href="index.php?route=/database/structure&db=green+apple&pos=0&sort=type&sort_order=ASC" title="Sort">Type</a></th>
                <th><a href="index.php?route=/database/structure&db=green+apple&pos=0&sort=collation&sort_order=ASC" title="Sort">Collation</a></th>
            
                                            <th><a href="index.php?route=/database/structure&db=green+apple&pos=0&sort=size&sort_order=DESC" title="Sort">Size</a></th>
                                <th><a href="index.php?route=/database/structure&db=green+apple&pos=0&sort=overhead&sort_order=DESC" title="Sort">Overhead</a></th>
    ...
    <tbody>
            <tr id="row_tbl_1" data-filter-row="OVERWEIGHT MEAL PLAN">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
            value="overweight meal plan"
            id="checkbox_tbl_1">
    </td>
    <th>
        <a href="index.php?route=/sql&db=green+apple&table=overweight+meal+plan&pos=0" title="">
            overweight meal plan
                ...
                <td class="text-center d-print-none">
                                    <a id="8252410055ce56ab64e4d8b3edf3f469_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=green+apple&ajax_request=1&favorite_table=overweight+meal+plan&add_favorite=1"
    title="Add to Favorites"
    data-favtargets="0445370b1b4f214f13e2fd69a674fe49">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=green+apple&table=overweight+meal+plan&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=green+apple&table=overweight+meal+plan">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=green+apple&table=overweight+meal+plan">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
            ...
            <a href="index.php?route=/table/change&db=green+apple&table=overweight+meal+plan"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=green+apple&table=overweight+meal+plan&sql_query=TRUNCATE+%60overweight+meal+plan%60&message_to_show=Table%2Boverweight%2Bmeal%2Bplan%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=green+apple&table=overweight+meal+plan&reload=1&purge=1&sql_query=DROP+TABLE+%60overweight+meal+plan%60&message_to_show=Table+overweight%26nbsp%3Bmeal%26nbsp%3Bplan+has+been+dropped.">
            ...
            data-table="overweight meal plan">
                            1
                ...
                <a href="index.php?route=/table/structure&db=green+apple&table=overweight+meal+plan#showusage">
            ...
            <tr id="row_tbl_2" data-filter-row="UNDERWEIGHT MEAL PLAN">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
            value="underweight meal plan"
            id="checkbox_tbl_2">
    </td>
    <th>
        <a href="index.php?route=/sql&db=green+apple&table=underweight+meal+plan&pos=0" title="">
            underweight meal plan
                ...
                <td class="text-center d-print-none">
                                    <a id="a8fdf221b65f7a89798276e3c53247cd_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=green+apple&ajax_request=1&favorite_table=underweight+meal+plan&add_favorite=1"
    title="Add to Favorites"
    data-favtargets="60d3928e17f6e31507497ee154149c42">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=green+apple&table=underweight+meal+plan&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=green+apple&table=underweight+meal+plan">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=green+apple&table=underweight+meal+plan">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=green+apple&table=underweight+meal+plan"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=green+apple&table=underweight+meal+plan&sql_query=TRUNCATE+%60underweight+meal+plan%60&message_to_show=Table%2Bunderweight%2Bmeal%2Bplan%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=green+apple&table=underweight+meal+plan&reload=1&purge=1&sql_query=DROP+TABLE+%60underweight+meal+plan%60&message_to_show=Table+underweight%26nbsp%3Bmeal%26nbsp%3Bplan+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
                ...
                <td class="value tbl_rows font-monospace text-end"
            data-table="underweight meal plan">
                            1
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=green+apple&table=underweight+meal+plan#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_3" data-filter-row="USER DETAILS">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=green+apple&table=user+details&pos=0" title="">
            user details
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="4d87dd608a0440f919459d527b5ac53b_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=green+apple&ajax_request=1&favorite_table=user+details&add_favorite=1"
    title="Add to Favorites"
    data-favtargets="1f14d9ba66b47655660a7f791dda1554">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=green+apple&table=user+details&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=green+apple&table=user+details">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=green+apple&table=user+details">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=green+apple&table=user+details"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=green+apple&table=user+details&sql_query=TRUNCATE+%60user+details%60&message_to_show=Table%2Buser%2Bdetails%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=green+apple&table=user+details&reload=1&purge=1&sql_query=DROP+TABLE+%60user+details%60&message_to_show=Table+user%26nbsp%3Bdetails+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="user details">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=green+apple&table=user+details#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
...
<tr>
    ...
    <th class="tbl_num text-nowrap">
                ...
                <th colspan="7" class="d-print-none">Sum</th>
                                                <th class="value tbl_rows font-monospace text-end">2</th>
...
<div class="modal fade" id="bulkActionModal" data-bs-backdrop="static" data-bs-keyboard="false"
  ...
  <p class="d-print-none">
    ...
    <a href="index.php?route=/database/data-dictionary&db=green+apple&goto=index.php%3Froute%3D%2Fdatabase%2Fstructure">
  ...
  <div class="card-body row row-cols-lg-auto g-3">
    ...
    <div class="col-12 align-self-lg-end">
      ...
      <a href="index.php?route=%2Fdatabase%2Fstructure&amp;db=green+apple&amp;server=1" title="Open new phpMyAdmin window" target="_blank" rel="noopener noreferrer">
